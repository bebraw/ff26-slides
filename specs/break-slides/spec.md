...
- [ ] The opening deck includes the approved introduction slides: logo-only title slide, welcome, MCs, edition, attendee count, workshop count, 18-speaker photo grid, conference format, themed session overview, hallway track, Pac-Man rule, sponsor logo tiers without visible sponsor names, meetups, code of conduct, hashtag, centered Q&A link, and Slack link rendered as a real href.
