...
Future Frontend 2026 needs a local slide deck for the beamer between conference sessions. The deck should tell attendees what is coming next, show the related talks and speakers for talk sessions, include simple schedule slides for items such as lunch and day endings, and keep sponsor visibility present without turning the layout into a marketing page.
...
- Then: the next slide becomes visible and the URL updates to `?slide=<number>`
