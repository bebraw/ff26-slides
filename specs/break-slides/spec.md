...
- [ ] The opening deck includes the approved introduction slides: logo-only title slide, welcome, MCs, edition, attendee count, workshop count, 18-speaker photo grid, conference format, themed session overview, hallway track, Pac-Man rule, centered Q&A link, sponsor logo tiers without visible sponsor names, meetups, code of conduct, hashtag, and Slack link rendered as a real href.
...
- [ ] The closing deck includes the approved retrospective slides: title, four-edition timeline, two-row numbers layout, early-signal topics, curated photo slides, thanks, speaker images, workshop instructor images, organizer images, MC images, attendee visualization, sponsor logos, partner logos, and SDLCAI handoff.
...
- `GET /closing` must keep rendering the closing deck title slide, four-edition timeline, early-signal topics, curated photo slides, speaker images, workshop instructor images, organizer images, MC images, attendee visualization, sponsor logos, partner logos, and SDLCAI handoff.
