...
export function ensureGeneratedBreakSlides(): void {
  mkdirSync(".generated", { recursive: true });
  writeFileSync(join(".generated", "break-slides.json"), JSON.stringify(parseSlideData(fallbackSlideData, emptySlideData)), "utf8");
}
