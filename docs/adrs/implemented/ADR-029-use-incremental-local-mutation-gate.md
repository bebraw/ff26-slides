# ADR-029: Use Incremental Local Mutation Gate
...
The template upstream added local testing speedups that avoid repeated full mutation runs while keeping full Stryker coverage in GitHub CI.
